...
case "$1" in
	...
	save)
		...
		if ipset -L -n VPNFlix-Master >/dev/null 2>&1; then { ipset save VPNFlix-Netflix; ipset save VPNFlix-Other; ipset save VPNFlix-Master; } > "/jffs/addons/vpnflix/vpnflix.ipset" 2>/dev/null; fi
